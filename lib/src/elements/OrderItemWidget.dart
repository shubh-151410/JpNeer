...
import 'package:markets/src/helpers/imageAdressConverter.dart';
                ...
                children: <Widget>[
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        DateFormat('dd-MM-yyyy').format(productOrder.dateTime),
                        style: Theme.of(context).textTheme.caption,
                      ),
                      Text(
                        DateFormat('hh:mm a').format(productOrder.dateTime),
                        style: Theme.of(context).textTheme.caption,
                      ),
                    ],
                  ),
